...
You can install the released version of hiesBD from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("hiesBD")
```
...
```r
library(hiesBD)
#> Error in library(hiesBD): there is no package called 'hiesBD'
## basic example code
```
